...
vim.keymap.set("n", "<leader>qlU", "<Plug>(lists-uniq-local)", {desc = "Remove repetitions within current list depth"})
vim.keymap.set("n", "<leader>qlT", "<Plug>(lists-bullet-toggle-local)", {desc = "Toggle bullet point for sibling list"})
